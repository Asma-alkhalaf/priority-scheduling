...
// By Asma from KeepSimulatorRunningExample
/*
 ...
 */
public class DynamicVmSubmitionWithSimulationRunning {
    /**
    ...
    public static void main(String[] args) {
        new DynamicVmSubmitionWithSimulationRunning();
    }

    private DynamicVmSubmitionWithSimulationRunning() {
